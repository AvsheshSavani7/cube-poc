  ...
  ({ url, radius, transparent, position, onLoad, onClick }, ref) => {
    ...
    if (texture?.isTexture) {
      ...
      function init() {
        ...
        // base mesh
        mesh = new THREE.Mesh(
          new THREE.SphereGeometry(1.5, 256, 256).toNonIndexed(),
        ...
        highlightWireframeMesh.material.color.copy(
          highlightMesh.material.color
        );
          ...
          if (params.toolMode === "box") {
            ...
            if (Math.abs(ex - prevX) >= 3 || Math.abs(ey - prevY) >= 3) {
              ...
              if (selectionPoints.length > 3) {
                ...
                tempVec0.set(
                  selectionPoints[i3 - 3],
                  selectionPoints[i3 - 3 + 1]
                );
        ...
        mesh.geometry.boundsTree.shapecast({
          intersectsBounds: (box, isLeaf, score, depth) => {
            ...
            const parentSegments =
              perBoundsSegments[depth - 1] || lassoSegments;
          ...
          intersectsTriangle: (tri, index, contained, depth) => {
            ...
            if (
              ...
              if (
                contained ||
                pointRayCrossesSegments(screenCentroid, segmentsToCheck) % 2 ===
                  1
              ) {
                ...
                if (params.selectionMode === "centroid-visible") {
                  ...
                  tempRay.origin
                    .copy(centroid)
                    .addScaledVector(faceNormal, 1e-6);
      ...
      // Handle case when texture is undefined
